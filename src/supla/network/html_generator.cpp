...
const char styles[] =
    ...
    "color:#00d150}.hint{font-size:.8em;opacity:.8;margin-top:2px}.hint.warn,"
    ".hint.error{opacity:1;border-radius:6px;padding:4px 6px}.hint.warn{"
    "background:#fff3cd;color:#5c4300}.hint.error{background:#f8d7da;color:#"
    "5c0008}a.wide-link,"
    ...
    "#f0f1f3;vertical-align:middle}.sensitive{transition:filter .15s "
    "ease}.privacy-mode .sensitive{filter:blur(7px);pointer-events:none;"
    "user-select:none}#privacy-toggle{position:fixed;right:12px;top:12px;"
    "z-index:1000;display:inline-flex;align-items:center;justify-content:"
    "center;width:48px;height:48px;margin:0;padding:0;border:0;border-radius:"
    "50%;background:#fff;color:#222;box-shadow:0 2px 8px rgb(0 0 0 / .3);"
    "cursor:pointer;-webkit-tap-highlight-color:transparent}#privacy-toggle "
    "svg{width:26px;height:26px;fill:none;stroke:currentColor;stroke-width:"
    "2;stroke-linecap:round;stroke-linejoin:round}#privacy-toggle .icon-eye-"
    "off{display:none}#privacy-toggle[aria-pressed=\"true\"] .icon-eye{"
    "display:none}#privacy-toggle[aria-pressed=\"true\"] .icon-eye-off{"
    "display:block}#privacy-toggle:active{transform:scale(.94)}"
    "</style>";
