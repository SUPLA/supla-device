...
const char styles[] =
    "<style>body{font-size:14px;font-family:Helvetica,Tahoma,Geneva,Arial,sans-"
    "serif;background:#00d151;color:#fff;line-height:20px;padding:0}.s{width:"
    "580px;margin:0 auto;margin-top:calc(50vh - 340px);border:solid 3px "
    "#fff;padding:0 10px "
    "10px;border-radius:15px}#l{display:block;max-width:150px;height:155px;"
    "margin:-80px auto 20px;background:#00d151;padding-right:5px}#l "
    "path{fill:#000}.w{margin:3px 0 16px;padding:5px "
    "0;border-radius:10px;background:#fff;box-shadow:0 5px 6px "
    "rgba(0,0,0,.3)}h1,h3{margin:10px "
    "8px;font-family:Helvetica,Tahoma,Geneva,Arial,sans-serif;font-weight:300;"
    "color:#000;font-size:23px}h1{margin-bottom:14px;color:#fff}span{display:"
    "block;margin:10px 7px "
    ...
    "display:inline-block;top:5px;left:8px;color:#00d151;pointer-events:none;"
    "font-size:min(14px,3vw);width:180px}input,select,textarea{width:calc(100% "
    "- "
    "183px);border:none;font-size:16px;line-height:40px;letter-spacing:-.5px;"
    "background:#fff;color:#000;padding-left:180px;-webkit-appearance:none;-"
    "moz-appearance:none;appearance:none;outline:0!important;height:40px}"
    "select{padding:0;float:right;margin:1px 3px 1px "
    "2px}button{width:100%;border:0;background:#000;padding:5px "
    "10px;font-size:16px;line-height:40px;color:#fff;border-radius:15px;box-"
    "shadow:0 1px 3px "
    "rgba(0,0,0,.3);cursor:pointer}.c{background:#ffe836;position:fixed;width:"
    "100%;line-height:80px;color:#000;top:0;left:0;box-shadow:0 1px 3px "
    "rgba(0,0,0,.3);text-align:center;font-size:26px;z-index:100}@media all "
    "and (max-height:660px){.s{margin-top:80px}}@media all and "
    "(max-width:640px){.s{width:calc(100% - "
    ...
    "input,select,textarea{width:calc(100% - "
    "20px);font-size:16px;line-height:28px;padding:0 5px;border-bottom:solid "
    "1px "
    "#00d151}select{width:100%;float:none;margin:0}}#proto_supla{display:none}."
    "proto_mqtt{display:none}textarea{resize:none;font-size:12px;line-height:"
    "12px}</style>";
