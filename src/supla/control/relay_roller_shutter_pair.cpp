...
RelayRollerShutterPair &RelayRollerShutterPair::setWeeklyScheduleAvailable(
    bool available) {
  relay0.setWeeklyScheduleAvailable(available);
  relay1.setWeeklyScheduleAvailable(available);
